...
#net.load_parameters('model_checkpoint/handwriting-0035.params')
net = gluon.nn.SymbolBlock.imports('model_checkpoint/handwriting-symbol.json',['data'],'model_checkpoint/handwriting-0035.params',ctx=ctx)
net.hybridize()
